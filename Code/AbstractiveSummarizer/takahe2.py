...
class word_graph:
    ...
    #-T-----------------------------------------------------------------------T-
    def __init__(self, sentence_list, nb_words=8, lang="bangla", punct_tag="PUNCT", pos_separator='/'):
    ...
    def get_edge_weight(self, node1, node2):
        ...
        #print(self.graph.node[node1])
        #print(self.graph.node[node2])
        #print("info1 : ", info1)
        #print("info2 : ", info2)
        #print('freq1: ', freq1)        
        #print('freq2: ', freq2)
...
class keyphrase_reranker:
    ...
    #-T-----------------------------------------------------------------------T-
    def __init__(self, sentence_list, nbest_compressions, lang="bangla", 
    ...
    def build_graph(self, window=0):
        ...
        for i in range(len(self.sentences)):
            ...
            #print('pinkponk',self.sentences)
            # Tokenize the current sentence in word/POS
            sentence = self.sentences[i].split(' ')
            #print('tingtong',sentence)
    ...
    def generate_candidates(self):
        ...
        #print(self.sentences)
        #print(len(self.sentences[0]))
        
        # For each sentence 
        for i in range(len(self.sentences)):
            #print('hey how are you?2')
            sentence = self.sentences[i]
            #print('hey how are you?3')
            ...
            for j in range(0,(len(sentence)-1)):
                ...
                # If a candidate keyphrase is in the buffer
                    ...
                    # Flush the buffer
                    candidate = []
                    #print('NotttCandidatee:',candidate)
                else:
                    #print('fasee Candidatee:',candidate)
                    # Flush the buffer
                    candidate = []
            ...
            if len(candidate) > 0 and self.is_a_candidate(candidate):
                ...
                keyphrase = ' '.join(u[0] for u in candidate)
                self.keyphrase_candidates[keyphrase] = candidate
            #print(self.keyphrase_candidates)
    #-B-----------------------------------------------------------------------B-
    ...
    def undirected_TextRank(self, d=0.85, f_conv=0.0001):
        ...
        #print('Tashdid Hossain Chowdhury')
    ...
    def cluster_keyphrase_candidates(self):
        ...
        for keyphrase in descending:
            ...
            #print('keyphrase_words:', keyphrase_words)
        ...
        #print('keyphrase 11:', self.keyphrase_candidates)
    #-B-----------------------------------------------------------------------B-
    ...
    def rerank_nbest_compressions(self):
        ...
        for cummulative_score, path in self.nbest_compressions:
            ...
            bisect.insort( reranked_compressions, 
                           (score, path) )
            #print('Hello World')
            #print('reranked_compressions',reranked_compressions)
